"""
Django settings for OwlEye project.
...
WSGI_APPLICATION = 'owleye.wsgi.application'
ASGI_APPLICATION = 'owleye.asgi.application'
...
DATABASES = {
    'default': {
        ...
        'NAME': os.getenv('DB_NAME', 'owleye_db'),
