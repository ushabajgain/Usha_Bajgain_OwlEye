    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(choices=[('attendee', 'Attendee'), ('organizer', 'Organizer'), ('volunteer', 'Volunteer'), ('authority', 'Authority / Admin'), ('admin', 'Admin')], default='attendee', max_length=20)),
